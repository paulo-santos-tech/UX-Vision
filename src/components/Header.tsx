      ...
      <div className="max-w-[1400px] w-full mx-auto px-6 flex justify-between items-center relative z-50">
        ...
        <nav className="hidden lg:flex items-center gap-8">
          ...
          <a
            ...
            className="bg-white/10 hover:bg-neon-purple/20 border border-white/20 hover:border-neon-purple text-white px-6 py-2.5 rounded-full font-semibold text-xs uppercase tracking-widest transition-all shadow-lg hover:shadow-neon-purple/20"
          >
            Orçamento
          </a>
        </nav>
